...
| Command | Description |
|---|---|
| `selector-healer init` | Create `.selector-healer/` directory and config template |
...
Create `selector-healer.config.ts` in your project root (or run `selector-healer init`):
